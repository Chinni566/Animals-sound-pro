function startClassification() {
  ...
  classifier = ml5.soundClassifier('https://teachablemachine.withgoogle.com/models/c0n5bvwqJ/model.json', modelReady);
}
...
function gotResults(error,results){
  ...
  document.getElementById("number_of_times").innerHTML = 'Detected Background Noise - '+background_noise+'<br>Detected Cat - '+meowing +'<br>Detected Cow - '+mooing;
